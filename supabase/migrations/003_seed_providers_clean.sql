-- ClearCross Progreso — Provider Seed Data (CLEAN)
-- All apostrophes escaped for PostgreSQL
DO $$
DECLARE
  cat_dentists uuid;
  cat_pharmacies uuid;
...
BEGIN
  ...
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Crystal Pharmacy', 'crystal-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, 'Part of Progreso Pharmacies consortium. Member of the curated ''best pharmacies'' listing. 30+ years in market.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'American Pharmacy', 'american-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"We have the lowest prices in town!" Part of Progreso Pharmacies consortium. 30+ years in market.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Valley Pharmacy', 'valley-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"Your health is our priority!" Part of Progreso Pharmacies consortium. 30+ years in market.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Linda Pharmacy', 'linda-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"It''s a pleasure to work for you!" Part of Progreso Pharmacies consortium. 30+ years. Also on Yelp.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Progreso Pharmacy', 'progreso-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"Hello my friends!" Part of Progreso Pharmacies consortium. 30+ years in market.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Almost Free Pharmacy', 'almost-free-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"The real almost free spot in town!" Part of Progreso Pharmacies consortium. Also on Yelp top 10.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Down Town Pharmacy', 'down-town-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"Come talk to us and you won''t go anywhere else!" Part of Progreso Pharmacies consortium.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Susy Pharmacy', 'susy-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"Over 30 years taking care of you and your family!" Part of Progreso Pharmacies consortium. Also on Yelp.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Rivera Pharmacy', 'rivera-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"We are always ready to serve you!" Part of Progreso Pharmacies consortium.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'JC Pharmacy', 'jc-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, '"Where you''ll find the best options for your health!" Part of Progreso Pharmacies consortium.', true, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Pancho''s Pharmacy', 'panchos-pharmacy', 'Nuevo Progreso, Tamaulipas, MX', '011528999370033', '011528999370033', 'https://eldiscosupercenter.com/panchos-pharmacy-nuevo-progreso-tamaulipas/', 'Save up to 80% on OTC and prescription medications. Conveniently located. Wide selection. Contact pharmacy to verify medication availability — person must purchase in person.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Good Prices Pharmacy', 'good-prices-pharmacy', 'Av. Benito Juarez #300-B entre Sonora y Tamaulipas, Zona Centro, Nuevo Progreso, MX', '011528999371000', '956-373-9500', NULL, '22 years of experience (since 1998). WhatsApp ordering available.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Farmacia Economy', 'farmacia-economy', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, 'Wide variety of generics and medical consultation at excellent prices. 809 Facebook likes, 239 check-ins.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  ...
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_pharmacies, 'Farmacia Centro Medico', 'farmacia-centro-medico', 'Nuevo Progreso, Tamaulipas, MX', NULL, NULL, NULL, 'Top-rated pharmacy on Yelp (2026). Also on Yelp top 10 drugstores list.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Desiree''s Spa & Massage', 'desirees-spa-massage', '', NULL, NULL, NULL, '#1 rated massage in Nuevo Progreso on Yelp. Full body massage, therapeutic massage, spa treatments.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, '325 Massage Studio', '325-massage-studio', '', NULL, NULL, NULL, 'Yelp top 3 massage in Nuevo Progreso. Professional massage studio.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Sundara Spa', 'sundara-spa', '', NULL, NULL, NULL, 'Yelp top 5 massage. Spa and wellness treatments.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Massage By Pippa', 'massage-by-pippa', '', NULL, NULL, NULL, 'Yelp top 5 massage. Therapeutic and relaxation massage.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Alpha Male Spa', 'alpha-male-spa', '', NULL, NULL, NULL, 'Yelp top 10 massage. Massage and spa services.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'RELAX STATION', 'relax-station', '', NULL, NULL, NULL, 'Yelp top 10 massage. Full body massage and relaxation services.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Gabriela Alvarez Massages', 'gabriela-alvarez-massages', '', NULL, NULL, NULL, 'Individual massage therapist. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_spas, 'Sapphire Spa', 'sapphire-spa', '', NULL, NULL, NULL, 'Spa and massage services. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Valle Vista Optical', 'valle-vista-optical', '', NULL, NULL, NULL, 'Top-rated optometrist on Yelp. Eye exams, prescription glasses, contact lenses.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'The Eye Experts', 'the-eye-experts', '', NULL, NULL, NULL, 'Eye exams, glasses, and contacts. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Optic Trend', 'optic-trend', '', NULL, NULL, NULL, 'Optical shop and eye care. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Eye Max', 'eye-max', '', NULL, NULL, NULL, 'Eye exams and optical services. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Flores Hernandez Nancy Abigail', 'flores-hernandez-optical', '', NULL, NULL, NULL, 'Individual optometrist practice. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Flores Castillo Cleto', 'flores-castillo-optical', '', NULL, NULL, NULL, 'Optometrist practice. Yelp top 10.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'America''s Best Contacts & Eyeglasses', 'americas-best-contacts-eyeglasses', '', NULL, NULL, NULL, 'National chain. Eye exams, contacts, prescription eyeglasses.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Ramirez Optical', 'ramirez-optical', '', NULL, NULL, NULL, 'FREE eye exam! Lenses and contact lenses. Shipping available. 359 FB likes.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_optometrists, 'Riverside Farmacia y Optica', 'riverside-farmacia-optica', '', NULL, NULL, NULL, 'Combined pharmacy and optical shop.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_cosmetic, 'State of Art Medical Center (956)', 'state-of-art-medical-center', '', NULL, NULL, NULL, 'Board-certified surgeons, 30+ years. Dr. Carlos Vergara. Free WhatsApp consultation.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_cosmetic, 'Accualaser Medical Spa', 'accualaser-medical-spa', '', NULL, NULL, NULL, 'State-of-the-art facility. Certified by Plastic Surgery Association of Mexico.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_cosmetic, 'Skin Perfections Medical Spa', 'skin-perfections-medical-spa', '', NULL, NULL, NULL, 'Top-rated medical spa on Yelp. Botox, fillers, skin treatments.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_doctors, 'Centro Medico Emanuel', 'centro-medico-emanuel', '', NULL, NULL, NULL, 'Medical center offering general medicine consultations.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_doctors, 'Anaya Medical Center', 'anaya-medical-center', '', NULL, NULL, NULL, 'Medical center offering doctor consultations and general health services.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_vets, 'Nuevo Progreso Veterinary Specialists', 'nuevo-progreso-vetspecialists', '', NULL, NULL, NULL, 'Specialized veterinary hospital for dogs and cats. 459 FB likes.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
  INSERT INTO providers (category_id, name, slug, address, phone, whatsapp, website, description, verified, featured, avg_rating, review_count)
  VALUES (cat_vets, 'Meds for Pets Nuevo Progreso', 'meds-for-pets-nuevo-progreso', '', NULL, NULL, NULL, 'Pet medications and veterinary services. Reddit-recommended.', false, false, NULL, 0)
  ON CONFLICT (slug) DO NOTHING;
