...
-- Categories
INSERT INTO public.categories (id, name, slug, icon, description, active, sort_order)
...
-- Procedures
INSERT INTO public.procedures (id, category_id, name, slug, description, sort_order)
...
-- Providers
INSERT INTO public.providers (id, category_id, name, slug, address, phone, whatsapp, website, description, logo_url, photo_url, graduation_year, verified, featured, plan, avg_rating, review_count, lat, lng)
...
-- Provider prices
INSERT INTO public.provider_prices (id, provider_id, procedure_id, price_usd, price_notes)
