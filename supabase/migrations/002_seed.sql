...
-- Providers
-- ⛔ verified / lat / lng / phone are deliberately ABSENT from the
...
ON CONFLICT (id) DO UPDATE SET name=EXCLUDED.name, address=EXCLUDED.address, whatsapp=EXCLUDED.whatsapp, website=EXCLUDED.website, description=EXCLUDED.description, logo_url=EXCLUDED.logo_url, photo_url=EXCLUDED.photo_url, graduation_year=EXCLUDED.graduation_year, featured=EXCLUDED.featured, plan=EXCLUDED.plan, avg_rating=EXCLUDED.avg_rating, review_count=EXCLUDED.review_count;
INSERT INTO public.clearcross_providers (id, category_id, name, slug, address, phone, whatsapp, website, description, logo_url, photo_url, graduation_year, verified, featured, plan, avg_rating, review_count, lat, lng)
