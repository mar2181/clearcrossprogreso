...
import BorderWait from '@/components/safety/BorderWait';
    ...
    <main className="w-full">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-neutral-light">
        <div className="max-w-4xl mx-auto">
          ...
          {/*
            ⛔ ABOVE the how-to card on purpose. The copy below now tells the
            reader to check the live figure instead of planning around an
            average, so the figure has to already be on screen when they read
            that sentence.
          */}
          <div className="mb-6">
            <BorderWait />
